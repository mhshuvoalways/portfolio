      ...
      <div className="flex justify-center lg:justify-between items-center gap-10 flex-wrap lg:flex-nowrap">
        ...
        <div className="w-full lg:w-9/12">
          ...
          <p className="mt-10 text-justify leading-8">
            I’m a professional and passionate Front-End Developer focused on
            ...
            its orbit. I am fascinated by web and mobile programming,
            development and building. I am gaining knowledge and ideas working
            in this area. I am keen to gain more experience in the field. My
            goal is to build applications that are scalable and efficient under
            ...
            and be a pleasant and friendly addition to the team. I am, therefore
            ...
            curious, committed, passionate, self-taught, enthusiastic, and also
            a fast learner!
            <br />
            <br />
