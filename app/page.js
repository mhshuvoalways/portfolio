...
const skills = [
  "JavaScript", "React.js", "Next.js", "Node.js", "React Native", 
  "TypeScript", "MongoDB", "AWS", "GraphQL", "Express.js"
];
    ...
    <Main>
        ...
        <div className="space-y-8 w-11/12 lg:w-7/12 relative">
          ...
          <div className="relative z-10">
            ...
            <div className="mt-4">
              <h2 className="text-white text2 font-semibold leading-relaxed">
                ...
                <span className="inline-block">Web & Mobile Application Developer</span>
              </h2>
            </div>
          </div>
              ...
              >
                <div className="relative p-3 bg-gray-900/50 backdrop-blur-sm border border-gray-700/50 rounded-xl hover:border-primary/50 transition-all duration-300 hover:scale-110 hover:bg-primary/10">
                  {el.name === "Fiverr" ? (
                    ...
                    <i className={`${el.icon} text-gray-400 group-hover:text-primary transition-colors duration-300`}></i>
                  )}
          ...
          <div className="relative z-10 space-y-6">
            <p className="text-gray-300 text3 font-medium leading-relaxed">
              🚀 As an expert in <span className="text-primary font-semibold">JavaScript, React.js, React Native, Next.js, Node.js, Express.js, GraphQL and AWS</span>, I specialize in building Web & Mobile Applications that not only look great but also deliver exceptional <span className="textGradient font-semibold">scalability, availability, usability, maintainability, reliability, and security</span>.
            </p>
          ...
          {/* Skills Tags */}
          <div className="relative z-10">
            <p className="text-gray-400 text-sm mb-3 font-medium">Technologies I work with:</p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 relative z-10">
            ...
            >
              <button className="btn relative z-10 group-hover:scale-105 transition-transform duration-300">
      ...
      <div className="mt-20 lg:mt-32">
        <div className="text-center mb-12">
          <h3 className="text2 font-bold textGradient mb-4">Achievements & Impact</h3>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
          {stats.map((stat, index) => (
            <div 
              ...
              style={{ animationDelay: `${index * 100}ms` }}
            >
              <div className="text-3xl lg:text-4xl font-bold textGradient mb-2">{stat.number}</div>
      ...
      <div className="mt-20 lg:mt-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            { title: "My Services", desc: "Web & Mobile Development", link: "/services", icon: "🛠️" },
            { title: "Portfolio", desc: "100+ Completed Projects", link: "/projects", icon: "💼" },
            { title: "Client Reviews", desc: "5-Star Testimonials", link: "/reviews", icon: "⭐" }
          ].map((item, index) => (
            <Link 
              key={item.title}
              href={item.link}
            ...
            >
              ...
              <h4 className="text-xl font-bold text-white mb-2 group-hover:text-primary transition-colors duration-300">{item.title}</h4>
